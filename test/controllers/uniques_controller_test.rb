...
class UniquesControllerTest < ActionController::TestCase
  ...
  test "should create unique" do
    assert_difference('Unique.count') do
      post :create, unique: { batch_id: @unique.batch_id, rand_num: @unique.rand_num, user_id: @unique.user_id }
    end
  ...
  test "should update unique" do
    patch :update, id: @unique, unique: { batch_id: @unique.batch_id, rand_num: @unique.rand_num, user_id: @unique.user_id }
    assert_redirected_to unique_path(assigns(:unique))
  end
